...
function $s_Lscalatags_generic_MouseEventAttrs$class__$$init$__Lscalatags_generic_MouseEventAttrs__V($$this) {
  var this$1 = new $c_Lscalatags_generic_Util$ExtendedString().init___Lscalatags_generic_Util__T($$this, "ondrag");
  $$this.ondrag$1 = this$1.nsAttr__Lscalatags_generic_Namespace__Lscalatags_generic_Attr(null)
}
...
function $s_Lscalatags_jsdom_Tags$class__p__Lscalatags_jsdom_Tags__Lscalatags_generic_TypedTag($$this) {
  return new $c_Lscalatags_generic_Util$ExtendedString().init___Lscalatags_generic_Util__T($$this, "p").tag__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag($m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1)
}
function $s_Lscalatags_jsdom_Tags$class__h1__Lscalatags_jsdom_Tags__Lscalatags_generic_TypedTag($$this) {
  return new $c_Lscalatags_generic_Util$ExtendedString().init___Lscalatags_generic_Util__T($$this, "h1").tag__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag($m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1)
}
function $s_Lscalatags_jsdom_Tags$class__div__Lscalatags_jsdom_Tags__Lscalatags_generic_TypedTag($$this) {
  return new $c_Lscalatags_generic_Util$ExtendedString().init___Lscalatags_generic_Util__T($$this, "div").tag__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag($m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1)
}
function $s_Lscalatags_jsdom_Tags$class__a__Lscalatags_jsdom_Tags__Lscalatags_generic_TypedTag($$this) {
  return new $c_Lscalatags_generic_Util$ExtendedString().init___Lscalatags_generic_Util__T($$this, "a").tag__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag($m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1)
}
/** @constructor */
function $c_O() {
  /*<skip>*/
...
function $c_Lscalatags_generic_Util$ExtendedString() {
  $c_O.call(this);
  this.scalatags$generic$Util$ExtendedString$$s$f = null;
  this.$$outer$f = null
}
...
$c_Lscalatags_generic_Util$ExtendedString.prototype.tag__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag = (function(namespaceConfig) {
  if ((!$m_Lscalatags_Escaping$().validTag__T__Z(this.scalatags$generic$Util$ExtendedString$$s$f))) {
    throw new $c_jl_IllegalArgumentException().init___T(new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["Illegal tag name: ", " is not a valid XML tag name"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.scalatags$generic$Util$ExtendedString$$s$f])))
  };
  var tag = this.scalatags$generic$Util$ExtendedString$$s$f;
...
$c_Lscalatags_generic_Util$ExtendedString.prototype.init___Lscalatags_generic_Util__T = (function($$outer, s) {
  this.scalatags$generic$Util$ExtendedString$$s$f = s;
  if (($$outer === null)) {
...
$c_Lscalatags_generic_Util$ExtendedString.prototype.nsAttr__Lscalatags_generic_Namespace__Lscalatags_generic_Attr = (function(namespaceConfig) {
  if ((!$m_Lscalatags_Escaping$().validAttrName__T__Z(this.scalatags$generic$Util$ExtendedString$$s$f))) {
    throw new $c_jl_IllegalArgumentException().init___T(new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["Illegal attribute name: ", " is not a valid XML attribute name"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.scalatags$generic$Util$ExtendedString$$s$f])))
  };
  return new $c_Lscalatags_generic_Attr().init___T__s_Option(this.scalatags$generic$Util$ExtendedString$$s$f, $m_s_Option$().apply__O__s_Option(namespaceConfig))
});
...
$c_Lscalatags_generic_Attr.prototype.init___T__s_Option = (function(name, namespace) {
  this.name$1 = name;
...
$c_Lscalatags_JsDom$all$.prototype.p$lzycompute__p1__Lscalatags_generic_TypedTag = (function() {
  if (new $c_sjsr_RuntimeLong().init___I__I(32768, 0).$$amp__sjsr_RuntimeLong__sjsr_RuntimeLong(this.bitmap$0$1).equals__sjsr_RuntimeLong__Z($m_sjsr_RuntimeLong$().Zero__sjsr_RuntimeLong())) {
    this.p$1 = $s_Lscalatags_jsdom_Tags$class__p__Lscalatags_jsdom_Tags__Lscalatags_generic_TypedTag(this);
    this.bitmap$0$1 = new $c_sjsr_RuntimeLong().init___I__I(32768, 0).$$bar__sjsr_RuntimeLong__sjsr_RuntimeLong(this.bitmap$0$1)
  };
  return this.p$1
});
...
$c_Lscalatags_JsDom$all$.prototype.h1$lzycompute__p1__Lscalatags_generic_TypedTag = (function() {
  if (new $c_sjsr_RuntimeLong().init___I__I(128, 0).$$amp__sjsr_RuntimeLong__sjsr_RuntimeLong(this.bitmap$0$1).equals__sjsr_RuntimeLong__Z($m_sjsr_RuntimeLong$().Zero__sjsr_RuntimeLong())) {
    this.h1$1 = $s_Lscalatags_jsdom_Tags$class__h1__Lscalatags_jsdom_Tags__Lscalatags_generic_TypedTag(this);
    this.bitmap$0$1 = new $c_sjsr_RuntimeLong().init___I__I(128, 0).$$bar__sjsr_RuntimeLong__sjsr_RuntimeLong(this.bitmap$0$1)
  };
  return this.h1$1
});
$c_Lscalatags_JsDom$all$.prototype.a__Lscalatags_generic_TypedTag = (function() {
  return (new $c_sjsr_RuntimeLong().init___I__I(268435456, 0).$$amp__sjsr_RuntimeLong__sjsr_RuntimeLong(this.bitmap$0$1).equals__sjsr_RuntimeLong__Z($m_sjsr_RuntimeLong$().Zero__sjsr_RuntimeLong()) ? this.a$lzycompute__p1__Lscalatags_generic_TypedTag() : this.a$1)
});
...
$c_Lscalatags_JsDom$all$.prototype.a$lzycompute__p1__Lscalatags_generic_TypedTag = (function() {
  if (new $c_sjsr_RuntimeLong().init___I__I(268435456, 0).$$amp__sjsr_RuntimeLong__sjsr_RuntimeLong(this.bitmap$0$1).equals__sjsr_RuntimeLong__Z($m_sjsr_RuntimeLong$().Zero__sjsr_RuntimeLong())) {
    this.a$1 = $s_Lscalatags_jsdom_Tags$class__a__Lscalatags_jsdom_Tags__Lscalatags_generic_TypedTag(this);
    this.bitmap$0$1 = new $c_sjsr_RuntimeLong().init___I__I(268435456, 0).$$bar__sjsr_RuntimeLong__sjsr_RuntimeLong(this.bitmap$0$1)
  };
  return this.a$1
});
...
//# sourceMappingURL=scalatags-fastopt.js.map
